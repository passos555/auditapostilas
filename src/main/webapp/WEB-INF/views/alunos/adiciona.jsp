...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Manutenção
        <small>Adicionar Apostila - Aluno(a)</small>
      </h1>
      <ol class="breadcrumb">
        <li>Home</li>
        <li>Alunos</li>
        <li class="active">Adicionar Apostila - Aluno(a)</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <!-- Horizontal Form -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Informações sobre o(a) aluno(a) - Escolha uma apostila!</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="${s:mvcUrl('AC#adicionarApostila').build() }" method="POST">
              ...
              <input type="hidden" value="${aluno.idAluno }" name="idAluno">
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" value="${aluno.nome }" name="nome" id="nome" disabled>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="email" class="form-control" value="${aluno.email }" name="email" id="email" disabled>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" value="${aluno.celular }" name="celular" id="celular" disabled>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <fmt:formatDate value="${aluno.dtNasc.time }" pattern="dd/MM/yyyy" var="dtFormat"/>
                    <input type="text" value="${dtFormat }" class="form-control" name="dtNasc" id="dtNasc" disabled>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" value="${aluno.cpf }" name="cpf" id="cpf" disabled>
                  </div>
                </div>
                
                <div class="form-group">
                <label class="col-sm-5 control-label">Aposila*</label>
                <div class="col-sm-2">
                <select name="idApostila" class="form-control select2 select2-hidden-accessible " style="width: 100%;" tabindex="-1" aria-hidden="true" required>

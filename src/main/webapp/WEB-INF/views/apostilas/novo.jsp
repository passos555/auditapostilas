...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Cadastro
        <small>Nova Apostila</small>
      </h1>
      <ol class="breadcrumb">
        <li>Home</li>
        <li>Apostilas</li>
        <li class="active">Nova Apostila</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content container-fluid">
        <!-- Horizontal Form -->
          <div class="box box-primary">
            ...
            <form class="form-horizontal" action="${s:mvcUrl('AC#gravar').build() }" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" onkeypress="validate(event)" class="form-control" name="paginas" id="paginas" required>
                  </div>
                </div>

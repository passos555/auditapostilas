...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Manutenção
        <small>Alterar Apostila</small>
      </h1>
      <ol class="breadcrumb">
        <li>Home</li>
        <li>Apostilas</li>
        <li class="active">Alterar Apostila</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <form class="form-horizontal" action="${s:mvcUrl('AC#alterar').build() }" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" value="${apostila.descricao }" class="form-control" name="descricao" id="descricao" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" onkeypress="validate(event)" value="${apostila.paginas }" class="form-control" name="paginas" id="paginas" required>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                <select name="tipo" class="form-control select2 select2-hidden-accessible " style="width: 100%;" tabindex="-1" aria-hidden="true" required>

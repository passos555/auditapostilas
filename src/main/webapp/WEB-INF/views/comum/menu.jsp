    ...
    <section class="sidebar">
      ...
      <div class="user-panel" style="margin-bottom:15px;">
        <div class="pull-left image">
          <img src="${contextPath}resources/dist/img/usuario.png" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>${usuarioLogado.login }</p>
          <p>${date }</p>
          <p><i class="fa fa-circle text-success"></i>Online - <a href="${contextPath}logout">Logout</a></p>
        </div>
      </div>

  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1 style="margin-bottom:10px;">
        Consulta
        <small>Log Apostila</small>
      </h1> 	
      <ol class="breadcrumb">
        <li>Home</li>
        <li>Logs</li>
        <li class="active">Apostilas</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Operações realizadas na tabela apostila</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                 <c:forEach items="${logs }" var="log">
	                <tr>
	                  ...
	                  <td>${log.apostila.descricao } - ${log.apostila.tipo }</td>
	                  <td align="center"><a class="open-Info" href="#modal-info" data-log-id="${log.idLogApostila }"
         ...
         <div class="modal-body">
          <form class="form-horizontal" action="/auditapostias/logs/alunos" method="POST">
              <div class="box-body">
                ...
                <tr>
                  <td style="border-right:2px solid;">Descrição</td>
                  <td>
                ...
                <tr>
                  <td style="border-right:2px solid;">Páginas</td>
                  <td>
                ...
                <tr>
                  <td style="border-right:2px solid;">Tipo</td>

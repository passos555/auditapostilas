        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Operações realizadas na tabela aluno</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                 <c:forEach items="${logs }" var="log">
	                <tr>
	                  ...
	                  <td>${log.aluno.nome } - ${log.aluno.cpf }</td>
	                  <td align="center"><a class="open-Info" href="#modal-info" data-log-id="${log.idLogAluno }"
         ...
         <div class="modal-body">
          <form class="form-horizontal" action="/auditapostias/logs/alunos" method="POST">
              <div class="box-body">
                ...
                <tr>
                  <td style="border-right:2px solid;">Nome</td>
                  <td>
                ...
                <tr>
                  <td style="border-right:2px solid;">CPF</td>
                  <td>
                ...
                <tr>
                  <td style="border-right:2px solid;">Dt. Nasc</td>
                ...
                <tr>
                  <td style="border-right:2px solid;">Email</td>
                  <td><input type="text" name="antes3" id="antes3" readOnly style="background-color:#f9f9f9;"></td>
                  <td>
                    <input type="text" name="depois1" id="depois3" readOnly style="background-color:#f9f9f9;">
                  </td>
                </tr>
                <tr>
                  <td style="border-right:2px solid;">Celular</td>
                  <td><input type="text" name="antes4" id="antes4" readOnly></td>
                  <td>
                    <input type="text" name="depois1" id="depois4" readOnly>
                  </td>
                </tr>
                <tr>
                  <td style="border-right:2px solid;">Sexo</td>
                  <td><input type="text" name="antes5" id="antes5" readOnly style="background-color:#f9f9f9;"></td>
                  <td>
                    <input type="text" name="depois1" id="depois5" readOnly style="background-color:#f9f9f9;">
                  </td>
                </tr>
                <tr>
                  <td style="border-right:2px solid;">Status</td>
                  <td><input type="text" name="antes6" id="antes6" readOnly ></td>
                  <td>
                    <input type="text" name="depois1" id="depois6" readOnly>
                  </td>
                </tr>
              </tbody></table>
                </div>
